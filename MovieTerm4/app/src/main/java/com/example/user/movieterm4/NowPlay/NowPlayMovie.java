...
public class NowPlayMovie extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_now_play_movie);
        ...
        //LayoutManager
        recyclerView.setLayoutManager(new GridLayoutManager(NowPlayMovie.this, 2));
    ...
    public class MyAsyncTask extends AsyncTask<String, Void, Movie[]> {
        //로딩중 표시
        ProgressDialog progressDialog = new ProgressDialog(NowPlayMovie.this);
        ...
        protected Movie[] doInBackground(String... strings) {
            ...
            Request request = new Request.Builder()
                    .url("https://api.themoviedb.org/3/movie/now_playing?api_key=dd3529cb48a78d9d2e775be63596398a&language=ko-KR&page=1&page2")
                    .build();
            try {
        ...
        protected void onPostExecute(Movie[] result) {
            ...
            //어답터 설정
            adapter = new MyRecyclerViewAdapter(NowPlayMovie.this, movieList);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu1) {
            if (k == "memberId"){
                Intent intent = new Intent(NowPlayMovie.this, Login.class);
                startActivity(intent);
            }else if(k != "memberId"){
                Intent intent = new Intent(NowPlayMovie.this, MemberInfo.class);
                startActivity(intent);
            }
        } else if (id == R.id.menu2) {
            Intent intent = new Intent(NowPlayMovie.this, NowPlayMovie.class);
            startActivity(intent);
        } else if (id == R.id.menu3) {
            Intent intent = new Intent(NowPlayMovie.this, WillPlayMovie.class);
            startActivity(intent);
        } else if(id == R.id.menu4) {
            Intent intent = new Intent(NowPlayMovie.this, BoxOffice.class);
            startActivity(intent);
        }else if(id == R.id.menu5) {
            Intent intent = new Intent(NowPlayMovie.this, MapInfo.class);
            startActivity(intent);
        }else if(id == R.id.menu6) {
            editor.clear();
            editor.commit();
            Intent intent = new Intent(NowPlayMovie.this, LoadingActivity.class);
            startActivity(intent);
        }else if(id==R.id.menu7){
            Intent intent = new Intent(NowPlayMovie.this, netXcha.class);
            startActivity(intent);
        }
