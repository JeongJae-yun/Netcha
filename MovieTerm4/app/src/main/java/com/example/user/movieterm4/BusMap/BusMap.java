...
import com.example.user.movieterm4.Map.PlaceInfo;
...
public class BusMap extends AppCompatActivity implements OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener,LocationListener, PlacesListener{
...
public void onMapLongClick(final LatLng latLng) {
        AlertDialog.Builder builder = new AlertDialog.Builder(BusMap.this);
...
public void onClick(View v) {
        ...
        Toast.makeText(BusMap.this, string_placeTitle+"\n"+string_placeDesc,Toast.LENGTH_SHORT).show();
...
public void onInfoWindowClick(Marker marker) {
        ...
        Intent intent = new Intent(getBaseContext(), StationInfo.class);
